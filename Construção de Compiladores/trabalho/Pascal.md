...
- A gramática do Pascal usada aqui não permite a construção com apenas IF-THEN, impedindo o problema de *dangling else*. Portanto, toda construção de condicional deve conter tanto os enunciados do THEN como os do ELSE.
